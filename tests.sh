...
run() {
    ...
    expect 0 ./main.py create "s0 c+,1-99"
    expect 0 ./main.py create "s0 c+,1-99:"
    expect 2 ./main.py create "s0 c+,1-99:n" # TODO cover for negative_allowed
    expect 2 ./main.py create "s0 c+,1-99:.2" # TODO cover for decimal
    expect 2 ./main.py create "s0 c+,1-99:.2%10" # TODO cover for decimal
    expect 0 ./main.py create "s0 c+,1-99:<"
    expect 2 ./main.py create "s0 c+,1-99:n.2" # TODO cover for negative_allowed
    expect 2 ./main.py create "s0 c+,1-99:n.2%10" # TODO cover for negative_allowed
    expect 2 ./main.py create "s0 c+,1-99:n<" # TODO cover for negative_allowed
    expect 2 ./main.py create "s0 c+,1-99:.2n" # TODO cover for negative_allowed
    expect 2 ./main.py create "s0 c+,1-99:.2<" # TODO cover for decimal
    expect 2 ./main.py create "s0 c+,1-99:.2%10n" # TODO cover for negative_allowed
    expect 2 ./main.py create "s0 c+,1-99:.2%10<" # TODO cover for decimal
    expect 2 ./main.py create "s0 c+,1-99:<n" # TODO cover for negative_allowed
    expect 2 ./main.py create "s0 c+,1-99:<.2" # TODO cover for decimal
    expect 2 ./main.py create "s0 c+,1-99:<.2%10" # TODO cover for decimal
    announce_block "create/params/seq_params/kind.cover/optional: err"
    expect 2 ./main.py create "s0 c+,1-99n"
    ...
    expect 2 ./main.py create "s0 c+,1-99:.2%-1.2" # TODO cover for decimal
    expect 2 ./main.py create "s0 c+,1-99:7n" # TODO cover for negative_allowed
    ...
    expect 2 ./main.py create "s0 c+,1-99:xn" # TODO cover for negative_allowed
    ...
    expect 2 ./main.py create "s0 c+,1-99:?.2%10" # TODO cover for decimal
    expect 2 ./main.py create "s0 c+,1-99:?<"
    expect 2 ./main.py create "s0 c+,1-99:nx" # TODO cover for negative_allowed
